...
export async function sendVerificationRequest(params: { identifier: string; provider: any; url: string; theme: Theme }) {
  ...
  <table width="100%" border="0" cellspacing="20" cellpadding="0"
    ...
    <tr>
      <td align="center"
        ...
        Если вы не запрашивали вход в личный кабинет, вы можете проигнорировать это письмо.
      </td>
    </tr>
  </table>
</body>
